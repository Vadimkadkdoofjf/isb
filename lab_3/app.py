...
from consts import DEFAULT_DIRECTORY, FILTER, IconTypes
from filework import FileWork
from hybrid_crypto_system.h_c_system import HybridCryptoSystem
...
class MainWindow(QMainWindow):
    ...
    def __init__(self):
        ...
        self.open_settings_button.setStyleSheet("""
            QPushButton {
                background-color: #d3d3d3;
                color: #333;
                border: 1px solid #ccc;
        ...
        """)
        self.select_key_length_button.setStyleSheet("""
            QPushButton {
                background-color: #d3d3d3;
                color: #333;
                border: 1px solid #ccc;
    ...
    def open_settings(self):
        try:
            ...
            if file:
                self.__settings = FileWork.open_file(file, "r")
                self.show_message(
